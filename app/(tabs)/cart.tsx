            ...
            {items.length === 0 ? (
                <View style={styles.emptyState}>
                    <View style={styles.emptyIcon}>
                        <Ionicons name="cart-outline" size={32} color={colors.accentDeep} />
                    </View>
                    ...
                    <View key={item.id} style={styles.itemRow}>
                        ...
                        <View style={styles.itemControls}>
                            ...
                            <TouchableOpacity style={styles.deleteButton} onPress={() => removeItem(item.id)}>
                                <Ionicons name="trash-outline" size={19} color={colors.accentDeep} />
                            </TouchableOpacity>
                        </View>
                    </View>
                ))
...
const styles = StyleSheet.create({
    ...
    totalPanel: { backgroundColor: colors.primaryDeep, borderRadius: 22, padding: 18, marginBottom: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', ...shadow },
    totalIcon: { width: 52, height: 52, borderRadius: 18, backgroundColor: 'rgba(255,255,255,0.16)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.22)' },
    totalLabel: { color: '#DCEEFF', fontSize: 12, fontWeight: '900', textTransform: 'uppercase' },
    totalValue: { color: 'white', fontSize: 31, fontWeight: '800', marginTop: 6 },
    totalMeta: { color: '#DCEEFF', fontSize: 13, marginTop: 4 },
    form: { backgroundColor: colors.surface, borderRadius: 22, padding: 15, borderWidth: 1, borderColor: colors.border, marginBottom: 16, ...shadow },
    sectionTitle: { color: colors.text, fontSize: 17, fontWeight: '800' },
    formHint: { color: colors.muted, fontSize: 13, marginTop: 4 },
    input: { height: 48, backgroundColor: colors.bg, borderRadius: 15, paddingHorizontal: 13, color: colors.text, borderWidth: 1, borderColor: colors.border, marginTop: 10 },
    formRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    priceInput: { flex: 1 },
    quantityInput: { width: 74 },
    addButton: { width: 48, height: 48, borderRadius: 16, backgroundColor: colors.accent, alignItems: 'center', justifyContent: 'center', marginTop: 10 },
    sectionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 },
    clearText: { color: colors.danger, fontWeight: '800' },
    emptyState: { alignItems: 'center', paddingVertical: 34, paddingHorizontal: 18, backgroundColor: colors.surface, borderRadius: 22, borderWidth: 1, borderColor: colors.border },
    ...
    emptyAction: { marginTop: 16, height: 42, paddingHorizontal: 18, borderRadius: 14, backgroundColor: colors.primaryDeep, flexDirection: 'row', alignItems: 'center', gap: 8 },
    emptyActionText: { color: 'white', fontWeight: '800' },
    itemRow: { backgroundColor: colors.surface, borderRadius: 20, padding: 13, borderWidth: 1, borderColor: colors.border, marginBottom: 10 },
    ...
    qtyButton: { width: 36, height: 36, borderRadius: 13, backgroundColor: colors.surfaceBlue, alignItems: 'center', justifyContent: 'center' },
    qtyText: { minWidth: 28, textAlign: 'center', color: colors.text, fontSize: 16, fontWeight: '800' },
    deleteButton: { width: 40, height: 36, borderRadius: 13, backgroundColor: colors.accentSoft, alignItems: 'center', justifyContent: 'center', marginLeft: 4 },
    checkoutButton: { marginTop: 8, height: 54, borderRadius: 18, backgroundColor: colors.accent, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, ...shadow },
